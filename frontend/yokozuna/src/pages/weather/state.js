...
const DayNightCycle = dynamic(() => import('@/components/cycles/DayNightCycle'), {
  ssr: false,
  loading: () => <div className="w-full h-full animate-pulse bg-yellow-200 dark:bg-yellow-900 rounded-lg" />
});

const PlanetRenderer = dynamic(() => import('@/components/pathtracing/PlanetRenderer'), {
  ssr: false,
  loading: () => <div className="w-full h-full animate-pulse bg-purple-200 dark:bg-purple-900 rounded-lg" />
});
